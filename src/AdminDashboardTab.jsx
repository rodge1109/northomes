    ...
    <div style={{ position: 'fixed', top: 0, left: '120px', right: 0, bottom: 0, display: 'flex', flexDirection: 'column', overflow: 'hidden', zIndex: 10, background: '#f8f9fa' }}>
      ...
      <div className="px-8 py-5 border-b border-black/5 bg-white shrink-0 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-2 border border-black/10 rounded-md px-3 py-1.5 bg-white shadow-sm cursor-pointer hover:bg-gray-50 transition-colors">
          ...
          <button className="flex items-center gap-2 px-3 py-1.5 bg-white border border-black/10 rounded-md text-[13px] font-bold text-black/80 hover:bg-gray-50 shadow-sm transition-colors">
          ...
          <button className="flex items-center gap-2 px-4 py-1.5 bg-[#005530] text-white hover:bg-[#004420] rounded-md text-[13px] font-bold shadow-sm transition-colors">
      ...
      <div className="flex-1 overflow-y-auto p-4">
        <div className="max-w-[1500px] mx-auto space-y-4">
          ...
          <div className="grid grid-cols-5 gap-2">
            ...
            {/* Occupancy */}
            <div className="bg-white border border-black/5 rounded-xl shadow-sm p-4 relative overflow-hidden flex flex-col justify-between">
            ...
            {/* Arrivals */}
            <div className="bg-white border border-black/5 rounded-xl shadow-sm p-4 relative flex flex-col justify-between group cursor-pointer hover:border-[#005530]/30 transition-colors">
            ...
            {/* Departures */}
            <div className="bg-white border border-black/5 rounded-xl shadow-sm p-4 relative flex flex-col justify-between group cursor-pointer hover:border-[#F59E0B]/30 transition-colors">
              <div className="flex items-start gap-3">
            ...
            {/* Rooms Available */}
            <div className="bg-white border border-black/5 rounded-xl shadow-sm p-4 relative flex flex-col justify-between group cursor-pointer hover:border-[#8B5CF6]/30 transition-colors">
              <div className="flex items-start gap-3">
            ...
            {/* Out of Order */}
            <div className="bg-white border border-black/5 rounded-xl shadow-sm p-4 relative flex flex-col justify-between group cursor-pointer hover:border-[#059669]/30 transition-colors">
              <div className="flex items-start gap-3">
          ...
          <div className="grid grid-cols-12 gap-2">
            ...
            {/* Revenue Summary */}
            <div className="col-span-3 bg-white border border-black/5 rounded-xl shadow-sm p-3 relative flex flex-col">
              <h3 className="text-[10px] font-bold text-black/60 uppercase tracking-widest mb-3">Revenue Summary (Live In-House)</h3>
              <div className="text-[24px] font-black text-[#005530] mb-3">{fmtCurrency(totalRevenue)}</div>
            ...
            <div className="col-span-6 bg-white border border-black/5 rounded-xl shadow-sm p-3 relative flex flex-col">
          ...
          <div className="grid grid-cols-3 gap-2">
            ...
            {/* Room Status */}
            <div className="bg-white border border-black/5 rounded-xl shadow-sm p-3">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="w-32 h-32 relative shrink-0">
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center text-center mt-1">
                    <span className="text-[16px] font-black leading-none text-black/90">{totalRooms}</span>
          ...
          <div className="grid grid-cols-3 gap-2 pb-12">
            ...
            <div className="bg-white border border-black/5 rounded-xl shadow-sm p-3">
              ...
              <div className="text-[11px]">
                ...
                {recent.length === 0 ? (
                  ...
                  <div key={i} className="grid grid-cols-5 py-1.5 items-center hover:bg-gray-50 -mx-2 px-2 rounded-md transition-colors cursor-pointer">
            ...
            <div className="bg-white border border-black/5 rounded-xl shadow-sm p-3 flex flex-col">
              <div className="flex justify-between items-center mb-3">
              ...
              <div className="flex items-center gap-3 flex-1">
                <div className="w-28 h-28 relative shrink-0">
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center text-center">
                    <span className="text-[16px] font-black leading-none text-black/90">{totalReservations}</span>
